...
from nichefinder_cli.workflows import check_rankings, generate_brief, rewrite_article, run_full_pipeline, write_article
...
def run_monitor_sync_action(
    *,
    ...
    slug, settings, _, session_context = _session_runtime(profile_slug, settings_override)
