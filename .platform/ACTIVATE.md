# Activation protocol — {{PROJECT_NAME}}

**Read this file when the user asks to "activate this project"** (or similar — "fill in the platform pack", "onboard this project", "run agentboard activation").
...
**Generated by `agentboard init` on {{TODAY}}.** After activation, this file stays in place so you can re-activate or re-run parts of the protocol later, but the root `CLAUDE.md` becomes the steady-state entry point.
