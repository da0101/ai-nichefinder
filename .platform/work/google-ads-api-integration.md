...
| 🟡 Medium | repo-primary | Optional credential gating is missing because settings have no Google Ads developer-token/customer/login fields. [packages/core/src/nichefinder_core/settings.py:27](/Users/danilulmashev/Documents/GitHub/ai-nichefinder/packages/core/src/nichefinder_core/settings.py:27) |
...
| Optional local credential/config handling | ❌ Missing | [packages/core/src/nichefinder_core/settings.py:27](/Users/danilulmashev/Documents/GitHub/ai-nichefinder/packages/core/src/nichefinder_core/settings.py:27) |
| Official Google Ads dependency/client | ❌ Missing | [packages/core/pyproject.toml:6](/Users/danilulmashev/Documents/GitHub/ai-nichefinder/packages/core/pyproject.toml:6) |
| Google Ads source module | ❌ Missing | `packages/core/src/nichefinder_core/sources/` |
| Existing ad-snippet agent | ✅ Existing, not this feature | [packages/core/src/nichefinder_core/agents/ads_agent.py:27](/Users/danilulmashev/Documents/GitHub/ai-nichefinder/packages/core/src/nichefinder_core/agents/ads_agent.py:27) |
...
| 2 | repo-primary | Add safe optional Google Ads config/readiness fields and `.env.example` placeholders. [packages/core/src/nichefinder_core/settings.py:27](/Users/danilulmashev/Documents/GitHub/ai-nichefinder/packages/core/src/nichefinder_core/settings.py:27) |
| 3 | repo-primary | Add an official Google Ads source adapter and mocked tests; current `AdsAgent` only reads SERP ad snippets. [packages/core/src/nichefinder_core/agents/ads_agent.py:30](/Users/danilulmashev/Documents/GitHub/ai-nichefinder/packages/core/src/nichefinder_core/agents/ads_agent.py:30) |
...
| # | Repo | Issue | Location |
|---|---|---|---|
| 1 | repo-primary | Rename or split current `AdsAgent` semantics when official Google Ads arrives; today “ads” means SERP ad-snippet analysis. | [packages/core/src/nichefinder_core/agents/ads_agent.py:22](/Users/danilulmashev/Documents/GitHub/ai-nichefinder/packages/core/src/nichefinder_core/agents/ads_agent.py:22) |
